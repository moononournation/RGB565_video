      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              // Dump audio
              aFile.read(buf, 12000);
              total_sd_pcm += millis() - curr_ms;
              curr_ms = millis();

              i2s_write_bytes((i2s_port_t)0, (char *)buf, 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 1200), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 2400), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 3600), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 4800), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 6000), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 7200), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 8400), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 9600), 1200, 0);
              i2s_write_bytes((i2s_port_t)0, (char *)(buf + 10800), 1200, 0);
