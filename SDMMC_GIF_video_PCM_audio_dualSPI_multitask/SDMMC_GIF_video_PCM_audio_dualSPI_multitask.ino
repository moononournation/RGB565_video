...
#define TFT_BL 22
Arduino_ESP32SPI_DMA *bus = new Arduino_ESP32SPI_DMA(27 /* DC */, 5 /* CS */, 18 /* SCK */, 23 /* MOSI */, 19 /* MISO */, VSPI);
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  Serial.printf("SD GIF: %d ms (%f %%)\n", total_sd_gif, 100.0 * total_sd_gif / time_used);
